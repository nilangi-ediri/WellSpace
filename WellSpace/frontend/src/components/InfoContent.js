                ...
                <Col md={8} lg={9}>
                    <Card id="mental-health" className="mb-4">
                        <Card.Body>
                            ...
                            <Card.Img variant="top" className="w-25" src="https://images.unsplash.com/photo-1611800065908-233b597db552?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                            <Card.Text>
                    ...
                    <Card id="mindfulness" className="mb-4">
                        <Card.Body>
                            ...
                            <Card.Img variant="top" className="w-25" src="https://images.unsplash.com/photo-1598826739205-d09823c3bc3d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                            <Card.Text>
                    ...
                    <Card id="emotional-wellbeing" className="mb-4">
                        <Card.Body>
                            ...
                            <Card.Img variant="top" className="w-25" src="https://images.unsplash.com/photo-1612531810887-6c402753239c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                            <Card.Text>
                    ...
                    <Card id="stress-management" className="mb-4">
                        <Card.Body>
                            ...
                            <Card.Img variant="top" className="w-25" src="https://images.unsplash.com/photo-1527856263669-12c3a0af2aa6?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                            <Card.Text>
